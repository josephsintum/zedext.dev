...
>
	<div
		class="relative overflow-hidden rounded-xl border transition-all duration-200 {focused ? 'border-[var(--color-accent)] shadow-lg shadow-amber-500/10' : 'border-[var(--color-border)] shadow-sm'}"
	>
		<svg
		...
		<div class="absolute right-4 top-1/2 -translate-y-1/2">
			<kbd class="hidden rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] px-1.5 py-0.5 font-mono text-[11px] text-[var(--color-text-tertiary)] sm:inline-block">/</kbd>
		</div>
	</div>
</div>
